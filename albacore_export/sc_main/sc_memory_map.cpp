...
void run_reset_step( memory_map& memory_map_inst, sc_time& current_time, const sc_time& cycle_time, int num_cycles ){

  std::cout << "Reset Memory Map" << endl;
  std::cout << "Instruction cycle start time - " << current_time << std::endl;
...
int sc_main(int argc, char* argv[]) {
    ...
    run_reset_step(memory_map_inst,current_time,cycle_time,1);  // 1 cycle with reset low
    ...
    memory_map_inst.mem_we = true;
	
    // Write 0x7220 at Memory[0]
	
    memory_map_inst.mem_addr = 0;
    memory_map_inst.mem_din = 0x7220;
    ...
    memory_map_inst.mem_addr = 1;
    memory_map_inst.mem_din = 0x8002;
    ...
    memory_map_inst.mem_addr = 2;
    memory_map_inst.mem_din = 0x8112;
    ...
    memory_map_inst.mem_addr = 3;
    memory_map_inst.mem_din = 0x0001;
    ...
    memory_map_inst.mem_addr = 4;
    memory_map_inst.mem_din = 0x9202;
    ...
    memory_map_inst.mem_addr = 5;
    memory_map_inst.mem_din = 0xF000;
    ...
    memory_map_inst.mem_addr = 32;
    memory_map_inst.mem_din = 0x0003;
    ...
    memory_map_inst.mem_addr = 33;
    memory_map_inst.mem_din = 0x0004;
    ...
    memory_map_inst.mem_we = false;
    memory_map_inst.mem_addr = 34;
    memory_map_inst.mem_din = 100;     // (dummy value not used in mem write)
    memory_map_inst.proc_we = true;
    memory_map_inst.proc_addr = 34;
    memory_map_inst.proc_din = 7;
    ...
    memory_map_inst.mem_we = false;  // ensure mem loader off
